        ...
        <div class="row">
            <form @submit.prevent="saveComplaint" class="col s12">
                ...
                <v-select 
                    ...
                    :options="[
                                {label:'- Pilih Ruangan -'},
                                {label:'IFLAB1', value:'iflab1'},
                                {label:'IFLAB2', value:'iflab2'},
                                {label:'IFLAB3', value:'iflab3'},
                                {label:'IFLAB4', value:'iflab4'},
                                {label:'IFLAB5', value:'iflab5'},
                                {label:'IKLAB1', value:'iklab1'},
                                {label:'IKLAB2', value:'iklab2'}
                            ]">
                </v-select>
